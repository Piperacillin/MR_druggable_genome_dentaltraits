...
if (grepl("EUR_perio_excl_HCHSSOL", unique(dat0.2$outcome), fixed = TRUE) == TRUE) {
  dat0.2$r.outcome <- get_r_from_lor(dat0.2$beta.outcome, af = dat0.2$eaf.outcome, ncase = 17353, ncontrol = 28210, prevalence = 0.01)
} else if (grepl("finngen_R9_K11_periodontitis_prep", unique(dat0.2$outcome), fixed = TRUE) == TRUE) {
  dat0.2$r.outcome <- get_r_from_lor(dat0.2$beta.outcome, af = dat0.2$eaf.outcome, ncase = 30377, ncontrol = 346900, prevalence = 0.01)
} else if (grepl("finngen_R9_K11_caries_prep", unique(dat0.2$outcome), fixed = TRUE) == TRUE) {
  dat0.2$r.outcome <- get_r_from_lor(dat0.2$beta.outcome, af = dat0.2$eaf.outcome, ncase = 161113, ncontrol = 216164, prevalence = 0.01)
} else if (grepl("finngen_R9_K11_nTeeth_prep", unique(dat0.2$outcome), fixed = TRUE) == TRUE) {
  dat0.2$r.outcome <- get_r_from_lor(dat0.2$beta.outcome, af = dat0.2$eaf.outcome, ncase = 3291, ncontrol = 259234, prevalence = 0.01)
} 
