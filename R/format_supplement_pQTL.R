...
write.table(significant_res_with_druggability_info, "full_results/significant_genes_results_all_outcomes_pQTL.txt", row.names = F, sep = "\t")
...
write.table(significant_qc, "full_results/significant_genes_qc_all_outcomes_pQTL.txt", row.names = F, sep = "\t")
...
write.table(full_res, "full_results/all_genes_results_all_outcomes_pQTL.txt", row.names = F, sep = "\t")
...
write.table(full_qc, "full_results/all_genes_qc_all_outcomes_pQTL.txt", row.names = F, sep = "\t")
